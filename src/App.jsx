...
/* Fundo do logo = mesmo gradiente da tela Home → funde perfeitamente */
const HOME_BG = "radial-gradient(ellipse at 38% 12%, #101828 0%, #07090D 80%)";
const SPLASH_BG = "radial-gradient(ellipse at 50% 45%, #0E1522 0%, #07090D 100%)";

function Logo({ width, splash, style }) {
  return (
    <div style={{
      width: width || "min(52vw, 190px)",
      background: splash ? SPLASH_BG : HOME_BG,
      display: "inline-flex",
      alignItems: "center",
      justifyContent: "center",
      /* Sem border, sem overflow hidden, sem borderRadius
         O gradiente cobre exatamente o fundo do JPEG do logo
         tornando invisível qualquer borda entre logo e tela   */
    }}>
      <img
        src={LOGO_SRC}
...
function Splash({ onDone }) {
  ...
  return (
    <div style={{
      ...
      <Logo splash={true} style={{ animation: "lglow 2.5s ease-in-out infinite, fadeUp .9s cubic-bezier(.16,1,.3,1) both" }} />
