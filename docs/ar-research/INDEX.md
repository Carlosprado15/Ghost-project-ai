...
| [AR-KB-010](topics/AR-KB-010.md) | D / F | Swing-twist decomposition (MiKaPo) aplicada aos 3 pontos do Ghost: viabilidade + esboço de plano pra implementar a Opção B do AR-KB-004 sem herdar código GPL-3.0 | PROVAVEL | PULSO / CORPO |
| [AR-KB-011](topics/AR-KB-011.md) | G | DINOv2 (ou embedding visual similar) pra detectar produto fisicamente errado (não só cor errada) no QA de catálogo — pista trazida pelo Carlinhos de conversa paralela com Claude Chat, fontes ainda não trazidas; motivado por blind spot medido de qa-color-check.mjs (CW033 antigo não foi pego) | HIPOTESE | UNIVERSAL |
